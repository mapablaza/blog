---
title: '¿Por qué el hombre que inventó internet desconfía de las criptomonedas?'
author: 'Marta Apablaza R'
date: 2020-03-09
categories: ['Datos']
tags: ['Vincent Cerf', 'Blockchain', 'ComputerScience', 'CienciasdelaComputación', 'Datos']
summary: 'Blockchain es como la aspirina de las ciencias de la computación. Las personas creen que van a solucionar muchos problemas con esta tecnología y no creo que sea el caso.'
---
...
“Siempre pensé que las criptomonedas son una mezcla entre las apuestas y los bienes de alto riesgo. Las criptomonedas NO tienen valor intrínseco, situación que no sucede en el mundo real con otras monedas o bienes. Por ejemplo, una bolsa de trigo tiene un valor intrínseco pues aun cuando su precio suba o baje puede alimentar a personas. En cambio, una criptomoneda no tiene un valor intrínseco por lo que es una apuesta muy riesgosa y su transacción está muy cerca del esquema de ponzi”.
...
Al parecer, el científico que creó el internet tampoco se siente muy atraído por la tecnología “blockchain”.
